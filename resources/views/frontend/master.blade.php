...
<head>
     ...
     href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
        ...
        <title>Cypher- Fashion eCommerce HTML Template</title>
					...
					<div class="row">
						...
						<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
							...
							<div class="language-selector-wrapper dropdown js-dropdown float-right mr-3">
								<div class="top_second"><p class="medium text-muted m-0 p-0"> <a href="{{ route('show.data.req') }}" class="medium text-dark text-underline">API</a></p></div>
							</div>
							<div class="language-selector-wrapper dropdown js-dropdown float-right mr-3">
